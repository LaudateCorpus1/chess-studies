...
white could be persuaded to play \wmove{dxc5.} And indeed, the
mainline \bmove{Nc6} scores significantly better than the move
played.\footnote{\movecomment{5... Nc6} 29\%-41\%-30\%/612
games; \movecomment{5... cxd4} 35\%-45\%-20\%/49 games; Lichess masters
database accessed on \printdate{2019-08-08}.}
...
potential \wmove{Ne4}, \wmove{f5} ideas; and
...
While seemingly logical asking white what to do with \wmove{Ne5}, the problem here
...
since \wmove{f5} would start to undermine black's already weakened control of
the center.
...
play were either \wmove{Nxd3} or \wmove{h6.} Stoofvlees was
expecting \wmove{Rc7.}

Before playing \bmove{Rc7}, the move that had to be calculated carefully was
\wmove{Bxh7+.} However, that was not mating, as black is just in time to
organize defenses. Variation \variation{16... Rc7 17. Bxh7+
Kxh7 18. Qh5+ Kg8 19. Rf3 Qe8 20. Rh3 f5 21. Qh8+ Kf7 22. Qh5+ Kg8
23. Qh7+ Kf7} would end peacefully.
...
semi-open c-file. \wmove{Rc7} would also add a defender on the 7th
...
still suggests that black is still holding with \wmove{Nxd3.}
...
or a concrete plan was needed to meet the following \wmove{Qh2.} But
...
get trapped with \wmove{f6,} the alternatives were not better. For
example:
...
\mainline{23. Qh2 h5 24. f6 Bh6 25. Rxh5!}

Nice finishing touch. With best play, mate would follow in 12 more
